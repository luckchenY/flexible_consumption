...
class RouterRuleEnv(object):
    ...
    def reset(self, season):
        ...
        try:
            with open('envdata/ev_trips_data20.json', 'r', encoding='utf-8') as f:
        ...
        state_init[4]= self.pricepuchase[0]
        state_init[5] = 0.0
        return state_init
    ...
    def step(self, t, consumptionflag,power_input, ess_change, PG):
        ...
        next_state[4]=self.pricepuchase[t+1]
        next_state[5]= t%96
